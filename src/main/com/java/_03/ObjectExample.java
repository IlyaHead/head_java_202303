...
//    System.out.println(holder1.equals(childHolder));
    ...
    // transitive
    boolean transitive = holder1.equals(holder3)
        && holder3.equals(holder5)
        && holder1.equals(holder5);//true
    ...
    boolean consistent = resultAfter == resultBefore;
    ...
    Class<? extends Holder> aClass = holder3.getClass();


    /*Object obj = holder1;

    Class<?> aClass1 = holder1.getClass();
    Class<?> aClass2 = holder2.getClass();
